...
Generated by the campaign generator (see `03_CAMPAIGN_GENERATOR_BRIEF.md`) using a genre pack. Node-mode campaigns are produced when the generator runs with `CG_NODE_MODE=1`.
