...
def build_seed_template(pack: GenrePack) -> str:
    ...
    lines = [
        ...
        "",
        "# Optional: force a consistent visual direction for NPC portraits.",
        "# image_style_hint: >",
        "#   Full-body photorealistic character portrait, realistic skin texture,",
        "#   natural anatomy, cinematic lighting. No illustration, comic, or painting look.",
        "",
        "# Optional structural controls (v2 / story-mode).",
        "# num_npcs: 18",
        "# num_locations: 12",
        "# num_factions: 4",
        "# num_truths: 7            # campaign-truth count (the GM never sees the whole set)",
        "# num_complications: 12    # campaign-specific complications on top of __pack_complications",
        "# num_sample_characters: 5",
        "",
        "# Optional generation controls.",
        "# random_seed: 12345",
        "# model: openai/gpt-4o-mini   # global override; pins every stage to this model",
        "# temperature: 0.8",
        "",
        "# Optional per-stage model overrides. Values may be 'primary' or",
        "# 'cheap' (resolved via $PRIMARY_MODEL / $CHEAP_MODEL env), or a",
        "# literal OpenRouter model id. See campaign_generator/README.md for",
